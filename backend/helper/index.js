...
function extracted1(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type) {
...
function extracted2(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type) {
...
function extracted3(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type) {
...
function extracted4(answers, modelTimestamps, timestamps) {
  name = answers["29"];
...
function extracted6(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type, aiims_id) {
  ...
  const {
    ...
    angina,
    cardiac_exertion
  } = cardiac_analysis(answers, "71.0 Cardiac screening", modelTimestamps, timestamps, varToString);
...
function extracted5(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type) {
...
function extracted7(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type) {
  can_feel_nose_and_cheek = answers["4"] === "0" ? "Yes" : "No";
  modelTimestamps.push({ id: "can_feel_nose_and_cheek", time: timestamps["53"] });
  can_close_eyes = answers["6"] === "0" ? "Yes" : "No";
  modelTimestamps.push({ id: "can_close_eyes", time: timestamps["53"] });
...
function extracted8(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type) {
  steroids_taken = answers["35"] === "0" ? getQuestionById(47).options[answers["47"]].dbValue : "";
  modelTimestamps.push({ id: "steroids_taken", time: timestamps["35"] });
  oxygen_support_duringcovid = getQuestionById(49).options[answers["49"]].dbValue;
  modelTimestamps.push({ id: "oxygen_support_duringcovid", time: timestamps["49"] });
...
function extracted9(answers, modelTimestamps, timestamps) {
  can_feel_nose_and_cheek = answers["4"] === "0" ? "Yes" : "No";
  modelTimestamps.push({ id: "can_feel_nose_and_cheek", time: timestamps["53"] });
  can_close_eyes = answers["6"] === "0" ? "Yes" : "No";
  modelTimestamps.push({ id: "can_close_eyes", time: timestamps["53"] });
  ...
  if (!answers) {
    ...
    Doctor.find().distinct("hospital", (err, hospitals) => {
      ...
      if (type === "OPD") {
         ...
         */
        extracted9(answers, modelTimestamps, timestamps);
        // console.log(answers);
        if (answers["47"] === "1") {
          // hospitalized for covid
          // TODO: possibly wrong code, might need value reversal
          extracted8(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type);
        } else if (answers["47"] === "0") {
          // TODO: reverse values. possibly wrong code
          extracted7(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type);
        } else {
          // self assessed
          extracted5(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type);
        }
        ...
        extracted6(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type, aiims_id);
      } else {
        console.log("covid mucormycosis questionaire. else");
        // CoViD and Mucormycosis questionaire
        extracted4(answers, modelTimestamps, timestamps);
        // console.log(answers);
        if (answers["47"] === "1") {
          extracted3(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type);
        } else if (answers["47"] === "0") {
          extracted2(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type);
        } else {
          extracted1(answers, modelTimestamps, timestamps, mongooseModelCallback, hospital, type);
        }
        // console.log(answers)
      }
    });
...
function realTimeAnswersToModel(answers,Timestamps,session_id,mongooseModelCallback){
